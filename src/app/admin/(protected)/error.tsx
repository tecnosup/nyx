...
const INSTAGRAM_URL = "https://www.instagram.com/tecnosuporte/";
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-nyx-bg px-6">
      <div className="text-center max-w-md">
        <p className="label-mono text-nyx-muted mb-6">Erro no painel</p>
        <h1 className="heading-display text-5xl md:text-6xl text-nyx-ink mb-6">
          Algo deu errado.
        </h1>
        <p className="text-nyx-muted leading-relaxed mb-10">
          Ocorreu um erro inesperado no painel administrativo. Tente novamente — se persistir, entre em contato com o suporte técnico.
        </p>
