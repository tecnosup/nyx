...
const WHATSAPP_URL = "https://wa.me/5512981646555";
const INSTAGRAM_URL = "https://www.instagram.com/nyxxwear_/";
    ...
    <main className="min-h-screen flex items-center justify-center bg-nyx-bg px-6">
      <div className="text-center max-w-md">
        ...
        <p className="text-nyx-muted leading-relaxed mb-10">
          Tivemos um problema inesperado. Tente novamente — se persistir, fale com a gente pelo WhatsApp ou Instagram.
        </p>
